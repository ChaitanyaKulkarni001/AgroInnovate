...
export const categories = [
  ...
  export const products = [
    // Vegetables
    { name: "Organic Tomato", price: "₹60/kg", category: "Vegetables", rating: 4.5, stock: 150, description: "Fresh, organic tomatoes grown without pesticides.", specifications: [{ label: "Type", value: "Heirloom" }], images: ["https://images.pexels.com/photos/7511862/pexels-photo-7511862.jpeg?auto=compress&cs=tinysrgb&w=600"] },
